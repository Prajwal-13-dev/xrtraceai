...
def create_synthetic_session(brv, labels, meta, segments, anomaly_type):
    ...
    for start, end in segments:
        ...
        if anomaly_type == "HYPER_SPEED":
            ...
            # Add spatial jitter to hand positions only
            ...
            # Simulate a sudden vertical duck/dip (head_pos_y is now index 1)
            ...
            # Recompute head_pos_y velocity (index 14) to avoid corrupting quaternions
            if sub_start > 0:
